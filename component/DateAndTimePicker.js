...
import { getFormattedDate, showDate, } from "../utils/Util";
						...
						<View style={styles.textInput}>
							{!!this.props.value ? (
								<Text style={{ fontSize: 12, color: Colors.black }}>
									{mode === "date"
										? getFormattedDate(this.props.value)
										: this.props.value}
								</Text>
							) : (
								<Text
									style={{ fontSize: 12, color: Colors.black, opacity: 0.6 }}
								>
									{mode === "date" ? "" : this.props.placeholder ?? ""}
