  ...
  renderItem = ({ item }) => {
    ...
    return (
      ...
      >
        ...
        >
          <Text
            style={[globalStyles.labelName, globalStyles.pd0, globalStyles.w80]}
          >
            {/* {"Desc: "} */}
              ...
              return (
                <View style={globalStyles.sectionHeader}>
                  ...
                  <View style={globalStyles.sectionHeaderRight}>
                    <Text style={[globalStyles.sectionListHeaderWeekDay]}>
                      {moment(title, "YYYY-MM-DD").format("dddd")}
                    </Text>
                    <Text style={[globalStyles.sectionListHeaderMonthYear]}>
                      {showDate(title)}
                    </Text>
                  </View>
                </View>
