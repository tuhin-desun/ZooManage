...
import { Header, Loader, MultiSelectDropdown, OverlayLoader } from '../../component';
import Spinner from '../../component/tasks/Spinner';
import { Colors } from '../../config';
import AppContext from '../../context/AppContext';
import { ListUsers } from '../../utils/api';
import { addSectionInCharge, editSectionInCharge } from './../../services/AllocationServices';
...
export default class AddAllocation extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            isLoader: false,
            users: [],
            selectedUsers: this.props.route.params.inChargeData.users.map((v)=> {return {id:v.id,name:v.full_name}}),
            sections: [this.props.route.params.inChargeData],
            selectedSection: [this.props.route.params.inChargeData],
            editable: this.props.route.params.inChargeData.users.length > 0 ? true : false,
