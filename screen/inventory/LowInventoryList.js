    ...
    <Container>
        ...
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>
              Hi this product is already requested
            </Text>
              ...
              ? this.state.prevRequestData.map((item) => {
                  return (
                    <View style={styles.detailsContainer}>
                      ...
                      >{`Requested By: ${item.user_name}`}</Text>
                      <Text
                        style={styles.detailText}
                      >{`Department: ${item.dept_name}`}</Text>
                      <Text
                        style={styles.detailText}
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>
              Do you want to change order quantity?
            </Text>
            <View>
              <TouchableOpacity
                onPress={() => {
              ...
              >
                <Text style={styles.btnText}>
                  Order without changing quantity
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
