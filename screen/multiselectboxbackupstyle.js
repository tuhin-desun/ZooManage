...
import { View, FlatList, Text, TouchableOpacity, TextInput, ScrollView, Dimensions } from 'react-native'
...
const kOptionsHeight = { width: '100%', maxHeight:  Dimensions.get("window").height/2 }
